import { NuevaCard } from './types';

/**
 * Valida los campos del ciclo y del cupo, compartidos por el alta y la edición.
 *
 * Vive en `lib/` y no adentro de una ruta porque son las mismas seis reglas en
 * cuatro lugares: el alta y la edición de la web, que pasan por `app/api`, y
 * las dos del teléfono, que escriben contra la base sin ruta en el medio.
 * Duplicadas, tarde o temprano una se corrige y las otras no, y el día que eso
 * pase el teléfono va a dejar guardar un día de corte 32.
 */
