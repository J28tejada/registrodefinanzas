    ...
    <div className="bg-panel border border-linea rounded-xl p-4 sm:p-5 space-y-2.5">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <input
          ...
          className="min-w-0 bg-hundido border border-linea-fuerte rounded-lg px-3 py-2.5 text-sm text-tinta placeholder:text-tinta-3 focus:outline-none focus:border-tinta-3"
        />
      </div>
      ...
      {llevaSaldo(borrador) && (
        <div className="border border-linea rounded-xl p-3 space-y-2.5 bg-fondo">
          ...
          <div className="space-y-1">
            <label className="text-xs text-tinta-2">Límite de crédito</label>
            <input
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1 min-w-0">
              <label className="text-xs text-tinta-2">Día de corte</label>
              <input
            ...
            <div className="space-y-1 min-w-0">
              <label className="text-xs text-tinta-2">Día de pago</label>
              <input
                type="number" min="1" max="31" step="1" inputMode="numeric"
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1 min-w-0">
              <label className="text-xs text-tinta-2">Ya debías</label>
              <input
                type="number" min="0" step="0.01" inputMode="decimal"
          ...
          <label className="flex items-start gap-2 cursor-pointer pt-0.5">
            ...
            />
            <span className="text-xs text-tinta-2 flex items-center gap-1.5">
              <Bell className="w-3.5 h-3.5 text-tinta-2 flex-shrink-0" />
      ...
      <div className="flex flex-wrap gap-1.5 pt-0.5">
        {COLORES.map(c => (
          <button
            ...
            aria-label={`Color ${c}`}
            className={`w-7 h-7 rounded-md transition-transform ${borrador.color === c ? 'ring-2 ring-tinta scale-110' : ''}`}
